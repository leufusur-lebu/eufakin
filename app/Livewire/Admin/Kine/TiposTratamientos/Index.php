...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        $categoriasDef = TreatmentCategory::defFor('kine');
        $categories    = TreatmentCategory::where('module', 'kine')->orderBy('sort_order')->get();

        return view('livewire.admin.kine.tipos-tratamientos.index', [
            'grupos' => $tipos,
            'counts' => $counts,
