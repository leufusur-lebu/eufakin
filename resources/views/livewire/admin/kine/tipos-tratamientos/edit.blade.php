<div class="mx-auto max-w-4xl p-6">
    <div class="mb-4 flex items-center gap-2">
        ...
        <flux:heading size="xl">Editar protocolo</flux:heading>
    </div>
    ...
    <form wire:submit="save" class="space-y-6">
        <div class="rounded-xl border border-zinc-200 bg-white p-5 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <div class="grid gap-4 md:grid-cols-2">
                <flux:input wire:model="nombre" label="Nombre" required class="md:col-span-2" />
        ...
        <div class="rounded-xl border border-sky-200 bg-sky-50/40 p-5 dark:border-sky-900 dark:bg-sky-950/20">
            ...
            <div class="mt-3 rounded-lg bg-white p-3 text-xs dark:bg-zinc-900">
                💡 Total estimado: <strong class="text-sky-600">${{ number_format(($precio_base ?? 0) * ($sesiones_recomendadas ?? 1), 0, ',', '.') }}</strong>
            </div>
        ...
        <div class="rounded-xl border border-zinc-200 bg-white p-5 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <div class="space-y-4">
                ...
                <flux:textarea wire:model="contraindicaciones" label="Contraindicaciones" rows="2" />
            </div>
        </div>
