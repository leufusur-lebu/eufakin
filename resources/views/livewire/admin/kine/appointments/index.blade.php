<div class="p-6 space-y-4">
    <div class="flex items-center justify-between">
        <div>
            <flux:heading size="xl">Agenda kinesiología</flux:heading>
        ...
        <div class="flex gap-2">
            ...
            <flux:button href="{{ route('admin.kine.appointments.create') }}" variant="primary" icon="plus" wire:navigate>Nueva</flux:button>
        </div>
    </div>
                            ...
                            <td class="min-w-[140px] border-b border-l p-1 align-top dark:border-zinc-700">
                                @foreach ($cell as $a)
                                    ...
                                    <div class="mb-1 rounded border px-2 py-1 {{ $bg }} {{ $estadoClass }}">
                                        ...
                                        <div class="font-medium">{{ $a->kineProfile?->person?->full_name ?? '—' }}</div>
                                        @if ($a->professional)
                                        ...
                                        <div class="mt-1 flex gap-1">
                                            @if ($canAttend)
                                                <a href="{{ route('admin.kine.sessions.attend', $a) }}" wire:navigate
                                            ...
                                            @endif
                                            <a href="{{ route('admin.kine.appointments.edit', $a) }}" wire:navigate
