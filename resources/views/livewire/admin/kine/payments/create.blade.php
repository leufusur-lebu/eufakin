<div class="p-6 max-w-2xl">
    <flux:heading size="xl">Nuevo pago kinesiología</flux:heading>

    <form wire:submit="save" class="mt-6 space-y-4">
        <div class="grid gap-4 md:grid-cols-2">
            <flux:select label="Paciente" wire:model.live="kine_profile_id" class="md:col-span-2">
            ...
            <flux:select label="Método" wire:model="metodo">
                ...
                <flux:select.option value="obra_social">Obra Social</flux:select.option>
        ...
        <div class="flex gap-2">
            ...
            <flux:button href="{{ route('admin.kine.payments.index') }}" variant="ghost" wire:navigate>Cancelar</flux:button>
        </div>
    </form>
</div>
